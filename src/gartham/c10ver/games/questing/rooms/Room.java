...
public interface Room {
	 ...
	 * resulting matrix is the same size as <code>{@link #layout()}.length</code>,
	 ...
	 * matrix returned by {@link #layout()}.
	 * 
	 * @return A string array, composed from the separate char arrays held in the
	 *         char matrix returned from {@link #layout()}.
	 */
	default String[] layoutLines() {
		var layout = layout();
